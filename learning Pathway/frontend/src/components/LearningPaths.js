...
const LearningPaths = () => {
  ...
  const groupCategories = (categories) => {
    ...
    categories.forEach(category => {
      if (category.engineeringField.includes('Computer') || category.engineeringField.includes('Software')) {
        groups['Computer & Software'].push(category);
      } else if (category.engineeringField.includes('Mechanical') || category.engineeringField.includes('Robotics')) {
        groups['Mechanical & Robotics'].push(category);
      } else if (category.engineeringField.includes('Electrical') || category.engineeringField.includes('Electronics')) {
        groups['Electrical & Electronics'].push(category);
      } else if (category.engineeringField.includes('Civil')) {
        groups['Civil & Construction'].push(category);
      } else if (category.engineeringField.includes('Chemical')) {
        groups['Chemical & Process'].push(category);
      } else if (category.engineeringField.includes('Aerospace')) {
